...
namespace ET
{
	public  class DlgAdventureViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.UI.LoopVerticalScrollRect ELoopScrollList_BattleLevelLoopVerticalScrollRect
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if( this.m_ELoopScrollList_BattleLevelLoopVerticalScrollRect == null )
     			{
		    		this.m_ELoopScrollList_BattleLevelLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"EG_Content/BackGround/ELoopScrollList_BattleLevel");
     			}
     			return this.m_ELoopScrollList_BattleLevelLoopVerticalScrollRect;
     		}
     	}
		...
		public void DestroyWidget()
		{
			...
			this.m_ELoopScrollList_BattleLevelLoopVerticalScrollRect = null;
		...
		private UnityEngine.UI.LoopVerticalScrollRect m_ELoopScrollList_BattleLevelLoopVerticalScrollRect = null;
