...
namespace ET
{
	public  class DlgBagViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.UI.Image E_TopButtonImage
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if( this.m_E_TopButtonImage == null )
     			{
		    		this.m_E_TopButtonImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"BackGround/E_TopButton");
     			}
     			return this.m_E_TopButtonImage;
     		}
     	}
		...
		public UnityEngine.UI.Toggle E_AmorToggle
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if( this.m_E_AmorToggle == null )
     			{
		    		this.m_E_AmorToggle = UIFindHelper.FindDeepChild<UnityEngine.UI.Toggle>(this.uiTransform.gameObject,"BackGround/E_TopButton/E_Amor");
     			}
     			return this.m_E_AmorToggle;
     		}
     	}
		...
		public UnityEngine.UI.Button E_CloseButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CloseButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"BackGround/ContentBackGround/E_Close");
     			}
		...
		public UnityEngine.UI.Image E_CloseImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CloseImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"BackGround/ContentBackGround/E_Close");
     			}
		...
		public UnityEngine.UI.Button E_PreviousButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PreviousButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"BackGround/ContentBackGround/Bottom/E_Previous");
     			}
		...
		public UnityEngine.UI.Image E_PreviousImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PreviousImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"BackGround/ContentBackGround/Bottom/E_Previous");
     			}
		...
		public UnityEngine.UI.Text E_PageText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_PageText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"BackGround/ContentBackGround/Bottom/E_Page");
     			}
		...
		public UnityEngine.UI.Button E_NextButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_NextButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"BackGround/ContentBackGround/Bottom/E_Next");
     			}
		...
		public UnityEngine.UI.Image E_NextImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_NextImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"BackGround/ContentBackGround/Bottom/E_Next");
     			}
		...
		public void DestroyWidget()
		{
			...
			this.m_E_TopButtonImage = null;
			this.m_E_WeaponToggle = null;
			this.m_E_AmorToggle = null;
		...
		private UnityEngine.UI.Image m_E_TopButtonImage = null;
		private UnityEngine.UI.Toggle m_E_WeaponToggle = null;
		private UnityEngine.UI.Toggle m_E_AmorToggle = null;
