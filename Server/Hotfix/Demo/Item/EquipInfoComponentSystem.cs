    ...
    public static class EquipInfoComponentSystem
    {
        ...
        public static void CreateEntry(this EquipInfoComponent self)
        {
            ...
            for (int i = 0; i < entryCount; i++)
            {
                ...
                attributeEntry.Value = RandomHelper.RandomNumber(entryConfig.AttributeMinValue,
            ...
            for (int i = 0; i < entryCount; i++)
            {
                EntryConfig entryConfig = EntryConfigCategory.Instance.GetRandomEntryConfigByLevel((int) EntryType.Special, entryRandomConfig.EntryLevel);
                if (entryConfig == null)
                {
                    continue;
                }
